...
#ifndef DYNAMIXEL_SDK_CUSTOM_INTERFACES__SRV__DETAIL__SYNC_GET_POSITION__FUNCTIONS_H_
#define DYNAMIXEL_SDK_CUSTOM_INTERFACES__SRV__DETAIL__SYNC_GET_POSITION__FUNCTIONS_H_
...
/// Initialize srv/SyncGetPosition message.
/**
...
/// Finalize srv/SyncGetPosition message.
/**
...
/// Create srv/SyncGetPosition message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dynamixel_sdk_custom_interfaces__srv__SyncGetPosition_Request__init().
...
/// Destroy srv/SyncGetPosition message.
/**
 * It calls
 * dynamixel_sdk_custom_interfaces__srv__SyncGetPosition_Request__fini()
...
/// Check for srv/SyncGetPosition message equality.
/**
...
/// Copy a srv/SyncGetPosition message.
/**
...
/// Initialize array of srv/SyncGetPosition messages.
/**
...
/// Finalize array of srv/SyncGetPosition messages.
/**
 * It calls
 * dynamixel_sdk_custom_interfaces__srv__SyncGetPosition_Request__fini()
...
/// Create array of srv/SyncGetPosition messages.
/**
 * It allocates the memory for the array and calls
 * dynamixel_sdk_custom_interfaces__srv__SyncGetPosition_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SyncGetPosition messages.
/**
 * It calls
 * dynamixel_sdk_custom_interfaces__srv__SyncGetPosition_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SyncGetPosition message array equality.
/**
...
/// Copy an array of srv/SyncGetPosition messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dynamixel_sdk_custom_interfaces__srv__SyncGetPosition_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dynamixel_sdk_custom_interfaces
...
/**
 * It calls
 * dynamixel_sdk_custom_interfaces__srv__SyncGetPosition_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dynamixel_sdk_custom_interfaces
...
/**
 * It allocates the memory for the array and calls
 * dynamixel_sdk_custom_interfaces__srv__SyncGetPosition_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dynamixel_sdk_custom_interfaces
...
/**
 * It calls
 * dynamixel_sdk_custom_interfaces__srv__SyncGetPosition_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DYNAMIXEL_SDK_CUSTOM_INTERFACES__SRV__DETAIL__SYNC_GET_POSITION__FUNCTIONS_H_
