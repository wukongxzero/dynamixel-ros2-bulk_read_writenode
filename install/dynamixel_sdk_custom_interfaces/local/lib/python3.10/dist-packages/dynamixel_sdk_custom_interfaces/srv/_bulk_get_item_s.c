...
bool dynamixel_sdk_custom_interfaces__srv__bulk_get_item__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_sdk_custom_interfaces.srv._bulk_get_item.BulkGetItem_Request", full_classname_dest, 70) == 0);
  }
  dynamixel_sdk_custom_interfaces__srv__BulkGetItem_Request * ros_message = _ros_message;
  {  // id1
...
{
  /* NOTE(esteve): Call constructor of BulkGetItem_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_sdk_custom_interfaces.srv._bulk_get_item");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BulkGetItem_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool dynamixel_sdk_custom_interfaces__srv__bulk_get_item__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_sdk_custom_interfaces.srv._bulk_get_item.BulkGetItem_Response", full_classname_dest, 71) == 0);
  }
  dynamixel_sdk_custom_interfaces__srv__BulkGetItem_Response * ros_message = _ros_message;
  {  // value1
...
{
  /* NOTE(esteve): Call constructor of BulkGetItem_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_sdk_custom_interfaces.srv._bulk_get_item");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BulkGetItem_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
