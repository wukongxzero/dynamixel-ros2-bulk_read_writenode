...
bool dynamixel_sdk_custom_interfaces__msg__sync_set_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_sdk_custom_interfaces.msg._sync_set_position.SyncSetPosition", full_classname_dest, 70) == 0);
  }
  dynamixel_sdk_custom_interfaces__msg__SyncSetPosition * ros_message = _ros_message;
  {  // id1
...
{
  /* NOTE(esteve): Call constructor of SyncSetPosition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_sdk_custom_interfaces.msg._sync_set_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SyncSetPosition");
